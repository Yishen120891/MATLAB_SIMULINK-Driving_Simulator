...
route.centrex = route.centrex(1:5:end);
route.centrey = route.centrey(1:5:end);
route.voieDx = route.voieDx(1:5:end);
route.voieDy = route.voieDy(1:5:end);
route.voieGx = route.voieGx(1:5:end);
route.voieGy = route.voieGy(1:5:end);
route.alpha = route.alpha(1:5:end);
route.rayon = route.rayon(1:5:end);
