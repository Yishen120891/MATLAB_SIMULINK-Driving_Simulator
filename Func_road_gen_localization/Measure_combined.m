function measures=Measure_combined(xv,yv,phi_v)

global route ind_route T_horizon v stp ls  XBord_PT YBord_PT
...
measures=[ro_previewed ; roref ; PsiL ; ind_act ; yact ; yL ; Angle_PT ; theta_near];
